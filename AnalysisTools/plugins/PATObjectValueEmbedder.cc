...
typedef PATObjectValueEmbedder<pat::Electron, float> PATElectronFloatEmbedder;
typedef PATObjectValueEmbedder<pat::Muon, float> PATMuonFloatEmbedder;
typedef PATObjectValueEmbedder<pat::Tau, float> PATTauFloatEmbedder;
typedef PATObjectValueEmbedder<pat::Jet, float> PATJetFloatEmbedder;
typedef PATObjectValueEmbedder<pat::CompositeCandidate, float> PATCompositeCandidateFloatEmbedder;
typedef PATObjectValueEmbedder<pat::Electron, bool> PATElectronBoolEmbedder;
typedef PATObjectValueEmbedder<pat::Muon, bool> PATMuonBoolEmbedder;
typedef PATObjectValueEmbedder<pat::Tau, bool> PATTauBoolEmbedder;
typedef PATObjectValueEmbedder<pat::Jet, bool> PATJetBoolEmbedder;
typedef PATObjectValueEmbedder<pat::CompositeCandidate, bool> PATCompositeCandidateBoolEmbedder;
...
DEFINE_FWK_MODULE(PATElectronBoolEmbedder);
DEFINE_FWK_MODULE(PATMuonBoolEmbedder);
DEFINE_FWK_MODULE(PATTauBoolEmbedder);
DEFINE_FWK_MODULE(PATJetBoolEmbedder);
DEFINE_FWK_MODULE(PATCompositeCandidateBoolEmbedder);
DEFINE_FWK_MODULE(PATElectronFloatEmbedder);
DEFINE_FWK_MODULE(PATMuonFloatEmbedder);
DEFINE_FWK_MODULE(PATTauFloatEmbedder);
DEFINE_FWK_MODULE(PATJetFloatEmbedder);
DEFINE_FWK_MODULE(PATCompositeCandidateFloatEmbedder);
