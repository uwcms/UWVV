...
triggerBranches = cms.PSet(
    ...
    singleESingleMuPaths = cms.vstring('HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v\\[0-9]+',
                                       'HLT_Mu8_TrkIsoVVL_Ele17_CaloIdL_TrackIdL_IsoVL_v\\[0-9]+',),
    singleMuSingleEPaths = cms.vstring('HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_v\\[0-9]+',
    ...
    singleIsoMuPaths = cms.vstring('HLT_IsoMu20_v\\[0-9]+',
                                   'HLT_IsoTkMu20_v\\[0-9]+',
                                   'HLT_IsoMu22_v\\[0-9]+',
                                   'HLT_IsoTkMu22_v\\[0-9]+',),
