...
${uwvv}/Utilities/scripts/submitJobs.py \
    -o ${uwvv}/submit_scripts/submitWZMonteCarloNoHLT_$DATE.sh \
...
${uwvv}/Utilities/scripts/submitJobs.py \
    -o ${uwvv}/submit_scripts/submitWZMonteCarloReHLT_$DATE.sh \
...
${uwvv}/Utilities/scripts/submitJobs.py \
    -o ${uwvv}/submit_scripts/submitWZMonteCarloWithHLT_$DATE.sh \
...
chmod +x $CMSSW_BASE/src/UWVV/submit_scripts/submitWZMonteCarloNoHLT_$DATE.sh
$CMSSW_BASE/src/UWVV/submit_scripts/submitWZMonteCarloNoHLT_$DATE.sh
chmod +x $CMSSW_BASE/src/UWVV/submit_scripts/submitWZMonteCarloReHLT_$DATE.sh
$CMSSW_BASE/src/UWVV/submit_scripts/submitWZMonteCarloReHLT_$DATE.sh
chmod +x $CMSSW_BASE/src/UWVV/submit_scripts/submitWZMonteCarloWithHLT_$DATE.sh
$CMSSW_BASE/src/UWVV/submit_scripts/submitWZMonteCarloWithHLT_$DATE.sh
